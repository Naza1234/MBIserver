...
<body style="background-color: #fff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fff;">
		...
		const message = {
				from: 'rofako82@gmail.com', // sender address
				to:req.body.email, // list of receivers
				subject: "MBI ticket approved", // Subject line
				html:html, 
			}
			transporter.sendMail(message,(error,info)=>{
				if(error){
...
exports.Sendcongmail= async(req,res)=>{
    try {  
...
<body style="background-color: #fff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fff;">
											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="heading_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<h3 style="margin: 0; color: #222222; direction: ltr; font-family: Arial, Helvetica, sans-serif; font-size: 18px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Dear ${req.body.username}</span></h3>
															</td>
														</tr>
													</table>
													<table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:35px;padding-left:10px;padding-right:10px;padding-top:30px;">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:1px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 17px;">Welcome to our community! We're thrilled to have you as a new member.</p>
																	<p style="margin: 0; margin-bottom: 17px;">Here's how our site works:</p>
																	<p style="margin: 0; margin-bottom: 17px;"><strong>1. View Upcoming Raffles:</strong> You can explore all the upcoming raffles on our platform. Find the ones that pique your interest and consider participating.</p>
																	<p style="margin: 0; margin-bottom: 17px;"><strong> 2. Request to Add Your Raffle:</strong> If you have a raffle of your own that you'd like to share with the community, you can request to add it to our site. Our team will review your request.</p>
																	<p style="margin: 0; margin-bottom: 17px;"><strong>3. Purchase Tickets:</strong> To participate in any ongoing raffle, click on the raffle you're interested in. You can then purchase tickets to join. Best of luck!</p>
																	<p style="margin: 0; margin-bottom: 17px;"><strong> 4. Manage Your Tickets: </strong>To keep track of your active tickets or see if you've won any, visit your profile. We have a dedicated section where you can view your tickets and their statuses.</p>
																	<p style="margin: 0; margin-bottom: 17px;">If you ever have questions or need assistance, our support team is here to help. Feel free to reach out to them anytime.</p>
																	<p style="margin: 0; margin-bottom: 17px;">Once again, welcome to our community, and we look forward to your active participation and success in our raffles.</p>
		...
		const message = {
				from: 'rofako82@gmail.com', // sender address
				to:req.body.email, // list of receivers
				subject: "welcome to MBI", // Subject line
				html:html, 
			}
			transporter.sendMail(message,(error,info)=>{
				if(error){
